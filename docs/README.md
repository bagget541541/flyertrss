...
- `系统规划.md`：系统目标、模块边界与总体规划
- `落地实施方案.md`：实施路径与执行方案
- `落地评估报告.md`：方案落地评估
- `卡片设计蓝图.md`：卡片与视觉设计规范
- `公众号读者价值与引流优化计划.md`：读者价值与引流方案
- `公众号图文优化清单.md`：公众号图文优化清单
- `正文文字化分析.md`：日报正文内容分析
- `LLM_RAG评估.md`：LLM/RAG 效果评估
- `QA_FIX_PLAN.md`：视觉 QA 修复计划
- `WECHAT_PUBLISH_FIXES.md`：公众号发布流程修复记录
- `BAT审查修复优先级_2026-08-03.md`：BAT 审查问题与修复优先级
- `CHANGELOG.md`：项目变更记录

运行时模板 `report_tpl.md`、根目录技能入口 `SKILL.md`、日报底稿和敏感配置不纳入文档归档。
